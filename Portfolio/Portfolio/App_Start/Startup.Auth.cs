    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "223443751454135",
               appSecret: "dcbca6b145d5018250976bc201841c4b");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "449187104859-g03ub9mi3bgs2vv4ktqgamhlvef49p7b.apps.googleusercontent.com",
                ClientSecret = "WpETdNDyZs4yDt73_Rk5OSbV"
            });
        }
    }
}